...
export default function ReviewsPage() {
  ...
  return (
    <div className="bg-canvas">
      {/* Hero */}
      <section className="pt-40 pb-32 md:pt-48 md:pb-48 border-b border-hairline">
      ...
      {/* Rating Summary */}
      <section className="py-20 border-b border-hairline bg-elevated">
        <div className="mx-auto max-w-[1440px] px-5 md:px-10">
                ...
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      size={24}
                      className="fill-rossa text-rossa"
                      aria-hidden="true"
                    />
                  ))}
                </div>
        ...
        <div className="mx-auto max-w-[1440px] px-5 md:px-10">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {reviews.map((review, idx) => (
              <div
                key={idx}
                className="p-8 border border-hairline rounded-lg bg-elevated hover:border-white/20 transition-colors"
              >
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <p className="font-600 text-white text-14px">{review.name}</p>
                ...
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      size={14}
                      className={i < review.rating ? 'fill-rossa text-rossa' : 'text-white/20'}
                      aria-hidden="true"
                    />
                  ))}
                </div>
                ...
                <div className="pt-4 border-t border-hairline">
                  <span className="label-uc text-8px text-white/40">
      ...
      {/* CTA */}
      <section className="py-24 bg-elevated border-t border-hairline">
