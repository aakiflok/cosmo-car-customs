...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-canvas">
            ...
            <div className="mb-10 grid grid-cols-2 gap-px bg-hairline">
              {[
                ...
                <div key={String(l)} className="bg-canvas p-5">
                  <div className="font-barlow font-bold text-[2rem] leading-none tracking-tight text-white">{v}</div>
      ...
      {/* Values */}
      <section className="border-t border-hairline bg-[#0d0d0d] w-full px-6 sm:px-10 lg:px-16 section-pad">
        <div className="mb-14">
          <span className="livery-line" />
