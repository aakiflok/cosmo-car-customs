    ...
    <div className="min-h-screen bg-canvas">
      ...
      <section className="container-pad page-hero">
        <div className="mx-auto max-w-[1440px]">
          ...
          <h1 className="display-xl mb-6 max-w-[780px] text-white fade-up">
      ...
      <section className="hairline bg-[#0d0d0d] container-pad section-pad">
        <div className="mx-auto max-w-[1440px]">
          <div className="mb-14">
            ...
            <h2 className="display-xl text-white max-w-[600px] fade-up">What we stand for.</h2>
          </div>
        ...
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="grid gap-px bg-[#1f1f1f] sm:grid-cols-3">
            {PROCESS_STEPS.map((step, i) => (
              <div key={step.title} className="bg-canvas p-10 fade-up" style={{ transitionDelay: `${i * 0.1}s` }}>
