    ...
    <div className="min-h-screen bg-canvas">
      ...
      <section className="relative flex min-h-[55vh] items-end overflow-hidden">
        <div className="absolute inset-0">
          <Image src={service.image} alt="" role="presentation" fill
      ...
      <section className="hairline bg-[#0d0d0d] container-pad section-pad">
        <div className="mx-auto max-w-[1440px]">
          <div className="mb-14">
            ...
            <h2 className="display-xl text-white fade-up">Choose your level of protection.</h2>
          </div>
          <div className="grid gap-px bg-[#1f1f1f] sm:grid-cols-2 lg:grid-cols-3">
            {service.packages.map((pkg, i) => (
              <div key={pkg.name} className="bg-[#0d0d0d] p-10 fade-up" style={{ transitionDelay: `${i * 0.08}s` }}>
        ...
        <section className="hairline container-pad section-pad">
          <div className="mx-auto max-w-[860px]">
            <div className="mb-14">
              ...
              <h2 className="display-xl text-white fade-up">Frequently asked.</h2>
            </div>
