    ...
    <section id="services" aria-labelledby="services-heading" className="bg-canvas px-5 py-24 md:px-10">
      <div className="mx-auto max-w-[1440px]">
        <div className="mb-14">
          ...
          <div className="label-uc mb-3 text-[9px] text-white/30">What we do</div>
          <h2 id="services-heading" className="display-xl text-white max-w-[700px] fade-up">
        ...
        <div className="grid gap-px bg-[#1f1f1f] sm:grid-cols-2 xl:grid-cols-5">
          {SERVICES.map((s, i) => (
            <Link key={s.slug} href={`/services/${s.slug}`}
              className="service-card group block bg-canvas"
