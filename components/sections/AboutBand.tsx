    ...
    <section aria-labelledby="about-heading" className="hairline bg-canvas px-5 py-24 md:px-10">
      <div className="mx-auto max-w-[1440px]">
        <div className="grid gap-px bg-[#1f1f1f] lg:grid-cols-2">
          ...
          {/* Photo */}
          <div className="relative min-h-[400px] overflow-hidden bg-canvas md:min-h-[560px]">
            <Image
          ...
          <div className="bg-canvas p-10 md:p-16">
            ...
            <div className="label-uc mb-3 text-[9px] text-white/30">About us</div>
            <h2 id="about-heading" className="display-xl mb-6 text-white fade-up">
              Precision detailing led by people who care.
            </h2>
            <p className="mb-5 text-[14px] leading-7 text-white/50">
