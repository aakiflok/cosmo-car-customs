  ...
  return (
    <section className="bg-[#222222] px-4 py-24 md:px-8 md:py-28">
      <div className="mx-auto grid max-w-[1280px] items-center gap-12 lg:grid-cols-2">
        <div>
          <div className="label-badge mb-3 text-white/40 reveal-up">Ceramic coating</div>
          <h2 className="display-xl mb-5 text-white clip-reveal delay-1">
            A finish so deep it looks like it came from the factory &mdash; only better.
          </h2>
          <p className="mb-5 max-w-[540px] text-[15px] leading-7 text-white/68 reveal-up delay-2">
          ...
          <ul className="mb-8 space-y-3 text-sm text-white/70">
            {[
              ...
              >
                <span className="mt-1 h-1.5 w-1.5 shrink-0 bg-rossa" />
                {item}
              </li>
            ))}
          </ul>
          <div className="reveal-up delay-7">
            <Link href="/services/ceramic-coating" className="btn-primary">
              <span>View Ceramic Coating</span>
            </Link>
          </div>
        </div>
        <div ref={canvasRef} className="relative min-h-[420px] border border-white/10 bg-canvas reveal">
          <div className="absolute left-4 top-4 z-10 border border-white/10 bg-black/40 px-3 py-2 label-badge text-white/55 backdrop-blur">
            3D finish simulation
          </div>
        </div>
      </div>
    </section>
